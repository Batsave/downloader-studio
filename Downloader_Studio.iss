...
; FFmpeg binaries (if bundled, optional - will be downloaded at install if missing)
Source: "dist\ffmpeg\bin\*"; DestDir: "{app}\ffmpeg\bin"; Flags: ignoreversion recursesubdirs createallsubdirs skipifsourcedoesntexist
